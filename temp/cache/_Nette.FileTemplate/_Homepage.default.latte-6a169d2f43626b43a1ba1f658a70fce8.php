<?php //netteCache[01]000341a:2:{s:4:"time";s:21:"0.40959000 1335114178";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:52:"C:\wamp\www\pok\app\templates\Homepage\default.latte";i:2;i:1335114173;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"013c8ee released on 2012-02-03";}}}?><?php

// source file: C:\wamp\www\pok\app\templates\Homepage\default.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'mugo0vzdzs')
;
// prolog NUIMacros
//
// block breadcrumb
//
if (!function_exists($_l->blocks['breadcrumb'][] = '_lb8de05da5db_breadcrumb')) { function _lb8de05da5db_breadcrumb($_l, $_args) { extract($_args)
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1587dfe79b_content')) { function _lb1587dfe79b_content($_l, $_args) { extract($_args)
...
"><?php echo NTemplateHelpers::escapeHtml($school_faculty['acronym'], ENT_NOQUOTES) ?></td>
      ...
      <td><?php echo NTemplateHelpers::escapeHtml($template->emptyPrice($school_faculty->free_money), ENT_NOQUOTES) ?></td>       
...
<?php $iterations++; endforeach; array_pop($_l->its); $iterator = end($_l->its) ?>
      ...
      <td><?php echo NTemplateHelpers::escapeHtml($template->emptyPrice($total_data->free_money), ENT_NOQUOTES) ?></td>			
