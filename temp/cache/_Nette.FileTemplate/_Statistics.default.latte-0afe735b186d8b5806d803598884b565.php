<?php //netteCache[01]000349a:2:{s:4:"time";s:21:"0.09234500 1334524113";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:60:"C:\xampp\htdocs\Timak\app\templates\Statistics\default.latte";i:2;i:1334482612;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"013c8ee released on 2012-02-03";}}}?><?php

// source file: C:\xampp\htdocs\Timak\app\templates\Statistics\default.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '97jmzbv3yz')
;
// prolog NUIMacros
//
// block breadcrumb
//
if (!function_exists($_l->blocks['breadcrumb'][] = '_lb6f1e6b85db_breadcrumb')) { function _lb6f1e6b85db_breadcrumb($_l, $_args) { extract($_args)
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb8dfc7017ef_head')) { function _lb8dfc7017ef_head($_l, $_args) { extract($_args)
?><!--Load the AJAX API-->
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba53649dba4_content')) { function _lba53649dba4_content($_l, $_args) { extract($_args)
?><h2>Štatistiky</h2>
<a class="design" href="<?php echo htmlSpecialChars($_control->link("Statistics:default")) ?>}">Štatistiky</a>
<a class="design" href="<?php echo htmlSpecialChars($_control->link("Statistics:facultystat")) ?>">Štatistiky fakúlt</a>
<script>
