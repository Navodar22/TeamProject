<?php //netteCache[01]000338a:2:{s:4:"time";s:21:"0.74418000 1335018548";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:49:"C:\wamp\www\pok\app\templates\Projects\edit.latte";i:2;i:1334918078;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"013c8ee released on 2012-02-03";}}}?><?php

// source file: C:\wamp\www\pok\app\templates\Projects\edit.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'mx0a0c3xxj')
;
// prolog NUIMacros
//
// block breadcrumb
//
if (!function_exists($_l->blocks['breadcrumb'][] = '_lbbd5b5a51e9_breadcrumb')) { function _lbbd5b5a51e9_breadcrumb($_l, $_args) { extract($_args)
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb407d41a61_content')) { function _lbb407d41a61_content($_l, $_args) { extract($_args)
...
<?php $iterations++; endforeach; array_pop($_l->its); $iterator = end($_l->its) ;$iterations++; endforeach; array_pop($_l->its); $iterator = end($_l->its) ?>
		...
		<tr class="total">
			...
			<td><?php echo NTemplateHelpers::escapeHtml($total_values['total']['hr'], ENT_NOQUOTES) ?></td>
...
<?php if (isset($total_values['approved'])): ?>
			<tr class="total-approved">
				...
				<td><?php echo NTemplateHelpers::escapeHtml($total_values['approved']['hr'], ENT_NOQUOTES) ?></td>
