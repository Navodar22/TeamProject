 ...
 *
 */
class PermissionPresenter extends BaseLPresenter
{
    /**
     * Init method
     */
...
//        $renderer->wrappers['label']['suffix'] = ':';
        ...
        $form->addMultiSelect('role_id', 'Role', $roles, 15)
                ->addRule(NForm::FILLED, 'You have to fill roles.')
                ->getControlPrototype()->class('w350');
        
        $form->addMultiSelect('resource_id', 'Resources', $resources, 15)
                ->addRule(NForm::FILLED, 'You have to fill resources.')
                ->getControlPrototype()->class('w350');
        
        $form->addMultiSelect('privilege_id', 'Privileges', $privileges, 15)
                ->addRule(NForm::FILLED, 'You have to fill privileges.')
                ->getControlPrototype()->class('w350');
        
        //$form->addSelect('access', 'Access', $access)
        $form->addRadioList('access', 'Access', $access)
                ->addRule(NForm::FILLED, 'You have to fill access.')
                ->getControlPrototype()->class('w200');
        
        $form->addSubmit('assign', 'Priraď')
